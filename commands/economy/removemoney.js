...
module.exports = {
    ...
    run: async (bot, message, args) => {
        if (!message.member.hasPermission("ADMINISTRATOR", "MANAGE_GUILD")) return message.channel.send("${emoji.error} You do not have permissions to remove money!");
        ...
        let moneyEmbed = new MessageEmbed()
            .setColor("GREEN")
            .setDescription(`${emoji.sucess} Removed ${args[1]} coins\n\nNew Balance: ${bal2}`);
